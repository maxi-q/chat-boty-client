  ...
  return (
    <main className={`section p-1 pt-2 laptop:p-5 laptop:pl-[50px] laptop:pt-[70px] ${styles.screen}`}>
      <div className="flex gap-16 desktop:gap-10">
        <div className="flex laptop:justify-center desktop:items-start desktop:justify-center flex-col items-center " style={{ flex: 1 }}>
          <h1 className={`${styles.title} text-xl laptop:text-[56px] laptop:leading-[67px] uppercase mt-24`}>
