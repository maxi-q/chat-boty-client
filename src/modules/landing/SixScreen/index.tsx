  ...
  return (
    <main className={'section bp-5 px-4 py-5 laptop:px-[40px] tablet:pt-10 laptop:pt-8 pb-8  ' + styles.screen}>
      ...
      <div className={'flex flex-wrap gap-4 justify-center'}>
        <Card
          date={'10.01.2025'}
          title={'Возможности чат-ботов во Вконтакте'}
          text={'Что можно сделать с ботами в ВК? В этой статье мы покажем вам функционал чат-ботов во Вконтакте, особенно эта статья будет полезна для новичков.'}
          describe={'Время прочтения: 4 минут'}
          link={'/blog/vozmozhnosti-chat-botov-vo-vkontakte'}
        />
        <Card
          date={'29.11.2024'}
          title={'Как создать чат-бота в Botman'}
          text={'Когда нам нужен бот среднего или малого функционала для Telegram, то мы часто используем botman, за его простой интерфейс и выскоую скорость разработки.'}
          describe={'Время прочтения: 9 минут'}
          link={'/blog/kak-sozdat-chat-bota-v-botman'}
        />
        <Card
          date={'01.10.2024'}
