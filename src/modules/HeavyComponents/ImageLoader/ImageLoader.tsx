...
const openImageLoader = (): Promise<IImage | null> => {
  return new Promise((resolve) => {
    const ImageLoaderComponent = () => {
      ...
      return <ImageLoaderModal isOpen={isModalOpen} onConfirm={handleConfirm} onClose={handleClose} />
    }

    if (root) {
      root.render(<ImageLoaderComponent />)
    }
  })
}

export default openImageLoader
