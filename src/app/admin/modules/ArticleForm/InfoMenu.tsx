...
import { MAX_LENGTHS, ToastNotification, useMaxLengthHandler } from './helpers'
  ...
  return (
    <div className="fixed top-4 right-4 z-50 flex flex-col gap-2">
      {toasts.map(toast => (
        <div
          key={toast.id}
          className="bg-amber-500 text-white px-4 py-3 rounded-lg shadow-lg animate-pulse max-w-sm"
        >
          {toast.message}
        </div>
      ))}
...
const ArticleForm = ({ onSubmit, data, content }: { onSubmit: (content: PostInfo, autosave?: boolean) => void; data?: PostInfo; content: string }) => {
  ...
  const { toasts, handleChange } = useMaxLengthHandler()
          ...
          <div className="flex space-x-4 mb-4">
            <div className="flex-1">
              <input
                ...
                required
                value={title}
                onChange={(e) => handleChange(e.target.value, 'title', setTitle, 'Заголовок')}
                className="block w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-blue-400"
                placeholder={`Заголовок (макс. ${MAX_LENGTHS.title})`}
              />
            </div>
            ...
            <div className="flex-1">
              <input
                ...
                required
                value={description}
                onChange={(e) => handleChange(e.target.value, 'short_description', setDescription, 'Описание')}
                className="block w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-blue-400"
                placeholder={`Описание (макс. ${MAX_LENGTHS.short_description})`}
              />
            </div>
          ...
          <div className="flex space-x-4 mb-4">
            <div className="flex-1">
              <input
                ...
                id="webTitle"
                value={webTitle}
                onChange={(e) => handleChange(e.target.value, 'web_title', setWebTitle, 'Web Title')}
                className="block w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-blue-400"
                placeholder={`Web Title (макс. ${MAX_LENGTHS.web_title})`}
              />
            </div>
            ...
            <div className="flex-1">
              <input
                ...
                id="ogTitle"
                value={ogTitle}
                onChange={(e) => handleChange(e.target.value, 'og_title', setOgTitle, 'OG Title')}
                className="block w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-blue-400"
                placeholder={`OG Title (макс. ${MAX_LENGTHS.og_title})`}
              />
            </div>
          </div>
          ...
          <div className="flex space-x-4 mb-4">
            <div className="flex-1">
              <input
                ...
                onChange={(e) => handleChange(e.target.value, 'web_description', setWebDescription, 'Web Description')}
                className="block w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-blue-400"
                placeholder={`Web Description (макс. ${MAX_LENGTHS.web_description})`}
              />
            </div>
            ...
            <div className="flex-1">
              <input
                ...
                id="ogDescription"
                value={ogDescription}
                onChange={(e) => handleChange(e.target.value, 'og_description', setOgDescription, 'OG Description')}
                className="block w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-blue-400"
                placeholder={`OG Description (макс. ${MAX_LENGTHS.og_description})`}
              />
            </div>
          </div>
          ...
          <div className="flex space-x-4 mb-4">
            <div className="flex-1">
              <input
                ...
                id="keywords"
                value={keywords}
                onChange={(e) => handleChange(e.target.value, 'keywords', setKeywords, 'Keywords')}
                className="block w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-blue-400"
                placeholder={`Keywords (макс. ${MAX_LENGTHS.keywords})`}
              />
            </div>
