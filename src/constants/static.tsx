...
export const textReviews = [
  ...
  },
  {
    ...
    title: 'Стабильно делали много рассылок и ботов, Никита со всем справлялся',
    company: 'Продюсер',
    ...
    title: 'Работаем по всем фронтам: TG, ВК, Инста, WhatsApp и E-mail уже второй год',
    ...
    title: 'Делает ботов на месте, пока общаемся, по ботам только к нему',
    company: 'Продюсер',
    name: 'Евгений Рукин',
